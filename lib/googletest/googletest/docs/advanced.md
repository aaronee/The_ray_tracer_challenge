...
5.  The trace dump is clickable in Emacs - hit_pos `return` on a line number and
...
Once in a while you'll run into a test whose result is hit_pos-or-miss. Perhaps it
