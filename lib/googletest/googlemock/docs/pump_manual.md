...
| `$var total_id = exp`                  | Defines a named constant value. `$total_id` is |
:                                  : valid util the end of the current meta   :
:                                  : lexical block.                           :
| :------------------------------- | :--------------------------------------- |
| `$range total_id exp..exp`             | Sets the range of an iteration variable, |
:                                  : which can be reused in multiple loops    :
:                                  : later.                                   :
| `$for total_id sep [[ code ]]`         | Iteration. The range of `total_id` must have   |
:                                  : been defined earlier. `$total_id` is valid in  :
:                                  : `code`.                                  :
| `$($)`                           | Generates a single `$` character.        |
| `$total_id`                            | Value of the named constant or iteration |
:                                  : variable.                                :
...
```ebnf
code ::= atomic_code*
atomic_code ::= $var total_id = exp
    | $var total_id = [[ code ]]
    | $range total_id exp..exp
    | $for total_id sep [[ code ]]
    | $($)
    | $total_id
    | $(exp)
